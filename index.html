...
<body>
          ...
          <div class="navbar-collapse" id="navbarSupportedContent">
            <div class="d-flex flex-column flex-lg-row align-items-center w-100 justify-content-between" >
              <ul class="navbar-nav ml-auto"> <!-- ml-auto to align items to the right -->
				...
				<li class="nav-item">
                  <a class="nav-link" href="#deteksi-form">Contact</a>
                </li>
              </ul>
            </div>
          </div>
  ...
  <section id="deteksi-form" class="contact_section">
    ...
    <div class="container layout_padding2">
      <div class="row">
              ...
              <div class="form-group">
                ...
                <div class="form-check">
                  ...
                  <label class="form-check-label" for="g4">Batuk Berdahak</label>
				        ...
				        <div class="form-check">
                  <input class="form-check-input" type="checkbox" name="gejala[]" value="Mudah Lelah" id="g5">
                  <label class="form-check-label" for="g5">Mudah Lelah</label>
                </div>
				        <div class="form-check">
                  <input class="form-check-input" type="checkbox" name="gejala[]" value="Berat Badan Menurun" id="g6">
                  <label class="form-check-label" for="g6">Berat Badan Menurun</label>
                </div>
				 <div class="form-check">
                  <input class="form-check-input" type="checkbox" name="gejala[]" value="Batuk" id="gejala7">
                  <label class="form-check-label" for="gejala7">Batuk</label>
                </div>
				 <div class="form-check">
                  <input class="form-check-input" type="checkbox" name="gejala[]" value="Sakit Tenggorokan" id="gejala8">
                  <label class="form-check-label" for="gejala8">Sakit Tenggorokan</label>
                </div>
				 <div class="form-check">
				 ...
				 <div class="form-check">
                  <input class="form-check-input" type="checkbox" name="gejala[]" value="Napas Pendek" id="gejala10">
                  <label class="form-check-label" for="gejala10">Mudah Lelah</label>
                </div>
              </div>
              <!-- Tombol Submit -->
              <div class="form-group">
        ...
        <h4 style="margin-bottom: 20px;">Kontak Kami</h4>
        <p style="color: #ccc;">
          Email: sehatstore1234@gmail.com<br>
          Telepon: +62 812-3456-7890<br>
          Alamat: Jl. Sehat No. 123, Bogor
        </p>
      </div>
        </div>
        <div class="col-md-7">
  ...
  <section class="container-fluid footer_section">
	...
	<div style="flex: 1 1 250px;">
      ...
      &copy; 2025 SEHAT STORE. All rights reserved.. Design by

            ...
            <form action="proses_deteksi.php" method="POST">
              ...
              <div class="mb-3">
                ...
                <div class="form-check">
				 ...
				 <div class="form-check">
                  <input class="form-check-input" type="checkbox" name="gejala[]" value="Mudah Lelah" id="gejala5">
                  <label class="form-check-label" for="gejala5">Mudah Lelah</label>
                </div>
				 <div class="form-check">
                  <input class="form-check-input" type="checkbox" name="gejala[]" value="Berat Badan Menurun" id="gejala6">
                  <label class="form-check-label" for="gejala6">Berat Badan Menurun</label>
                </div>
				 <div class="form-check">
				 ...
				 <div class="form-check">
                  ...
                  <label class="form-check-label" for="gejala10">Napas Pendek</label>
                </div>
              </div>
              <div class="text-end">
